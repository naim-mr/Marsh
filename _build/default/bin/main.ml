...
let funny_bernnoulli = model "funny_bernoulli" (letin  "a" (sample (d_bernoulli 0.5)) (letin "b" ((sample (d_bernoulli 0.5)))  (add (var "a") (var "b")) ))
let uni = model "uniform_test" (letin "a" (sample (d_uniformd 0. 2.)) (add (var "a") (var "a")))
let _ =
